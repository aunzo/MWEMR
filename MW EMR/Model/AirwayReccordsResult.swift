import ObjectMapper
class AirwayReccordsResult: NSObject,NSCoding, Mappable {
    ...
    func mapping(map: Map) {
        id <- map["MasterData_AIRWAY_ID"]
        consultId <- map["ConsultForm_CONSULT_ID"]
        isActive <- map["AIRWAY_REC_ISACTIVE"]
    ...
    required convenience init(coder aDecoder: NSCoder) {
        self.init()
        self.id = aDecoder.decodeInteger(forKey: "MasterData_AIRWAY_ID")
        self.consultId = aDecoder.decodeInteger(forKey: "ConsultForm_CONSULT_ID")
        self.isActive = aDecoder.decodeBool(forKey: "AIRWAY_REC_ISACTIVE")
    ...
    func encode(with aCoder: NSCoder) {
        aCoder.encode(self.id, forKey: "MasterData_AIRWAY_ID")
        aCoder.encode(self.consultId, forKey: "ConsultForm_CONSULT_ID")
        aCoder.encode(self.isActive, forKey: "AIRWAY_REC_ISACTIVE")
