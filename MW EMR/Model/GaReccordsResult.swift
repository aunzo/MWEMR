import ObjectMapper
class GaReccordsResult: NSObject,NSCoding, Mappable {
    ...
    func mapping(map: Map) {
        id <- map["MasterData_GA_ID"]
        consultId <- map["ConsultForm_CONSULT_ID"]
        isActive <- map["GA_RECCORD_ISACTIVE"]
    ...
    required convenience init(coder aDecoder: NSCoder) {
        self.init()
        self.id = aDecoder.decodeInteger(forKey: "MasterData_GA_ID")
        self.consultId = aDecoder.decodeInteger(forKey: "ConsultForm_CONSULT_ID")
        self.isActive = aDecoder.decodeBool(forKey: "GA_RECCORD_ISACTIVE")
    ...
    func encode(with aCoder: NSCoder) {
        aCoder.encode(self.id, forKey: "MasterData_GA_ID")
        aCoder.encode(self.consultId, forKey: "ConsultForm_CONSULT_ID")
        aCoder.encode(self.isActive, forKey: "GA_RECCORD_ISACTIVE")
